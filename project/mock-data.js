export const currentUser = { id: 'u0', displayName: 'You' };
...
// friends I can view the calendar of (their approval), null = no access yet
export const friendAccessOverrides = {
  u1: { level: 'full', scope: 'standing' },
  u2: { level: 'overlap', scope: 'range', rangeStart: '2026-07-01', rangeEnd: '2026-07-31' }
};

export const friendCalendars = {
  u1: {
    '2026-07-03': 'free', '2026-07-04': 'free', '2026-07-05': 'busy',
    '2026-07-11': 'free', '2026-07-12': 'maybe', '2026-07-18': 'busy',
    '2026-07-19': 'free', '2026-07-25': 'free', '2026-07-26': 'maybe'
  },
  u2: {
    '2026-07-02': 'free', '2026-07-04': 'free', '2026-07-09': 'busy',
    '2026-07-10': 'free', '2026-07-15': 'free', '2026-07-16': 'maybe',
    '2026-07-21': 'busy', '2026-07-28': 'free'
  }
};

export const initialIncomingRequests = [
  { id: 'r1', requesterId: 'u3', requesterName: 'Elena Cruz', scope: 'standing', rangeStart: null, rangeEnd: null },
  { id: 'r2', requesterId: 'u4', requesterName: 'Sam Okafor', scope: 'range', rangeStart: '2026-08-01', rangeEnd: '2026-08-07' }
];

export const initialStandingAccess = [
...
export const initialPolls = [
  {
    id: 'p1', title: 'Cabin weekend', note: 'Lake house — need to book by Friday', creatorId: 'u0',
    rangeStart: '2026-08-07', rangeEnd: '2026-08-10',
    invitees: [
    ...
    responses: {
      i1: { '2026-08-07': 'free', '2026-08-08': 'free', '2026-08-09': 'maybe', '2026-08-10': 'busy' },
      i2: { '2026-08-07': 'free', '2026-08-08': 'free', '2026-08-09': 'free', '2026-08-10': 'busy' },
      i3: { '2026-08-07': 'busy', '2026-08-08': 'free', '2026-08-09': 'free', '2026-08-10': 'maybe' },
      i4: { '2026-08-07': 'maybe', '2026-08-08': 'free', '2026-08-09': 'free', '2026-08-10': 'free' }
    }
  },
  {
    id: 'p2', title: 'Dinner this week', note: '', creatorId: 'u1',
    rangeStart: '2026-07-15', rangeEnd: '2026-07-18',
    invitees: [
    ...
    responses: {
      i7: { '2026-07-15': 'busy', '2026-07-16': 'free', '2026-07-17': 'free', '2026-07-18': 'maybe' },
      i8: { '2026-07-15': 'free', '2026-07-16': 'free', '2026-07-17': 'busy', '2026-07-18': 'free' }
    }
  },
  {
    id: 'p3', title: 'Beach day', note: '', creatorId: 'u0',
    rangeStart: '2026-06-20', rangeEnd: '2026-06-22',
    invitees: [
